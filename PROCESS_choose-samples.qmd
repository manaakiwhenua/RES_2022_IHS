...
pal <- colorNumeric(palette = scico(20, palette = 'batlow', begin = 0.3, end = 0.6,),
                    domain = c(0,1),
                    na.color = NA)
...
poss_pts_01 <- st_as_sf(data.frame(bs_01), 
                        coords = c(1, 2),
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_01, best_cells_01)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.))) 
```
...
poss_pts_02 <- st_as_sf(data.frame(bs_02), 
                        coords = c(1, 2), 
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_02, best_cells_02)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.)))
...
poss_pts_03 <- st_as_sf(data.frame(bs_03), 
                        coords = c(1, 2), 
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_03, best_cells_03)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.)))
...
poss_pts_04 <- st_as_sf(data.frame(bs_04), 
                        coords = c(1, 2), 
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_04, best_cells_04)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.)))
...
poss_pts_05 <- st_as_sf(data.frame(bs_05), 
                        coords = c(1, 2), 
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_05, best_cells_05)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.)))
...
poss_pts_06 <- st_as_sf(data.frame(bs_06), 
                        coords = c(1, 2), 
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_06, best_cells_06)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.)))
...
poss_pts_07 <- st_as_sf(data.frame(bs_07), 
                        coords = c(1, 2), 
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_07, best_cells_07)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.)))
...
poss_pts_08 <- st_as_sf(data.frame(bs_08), 
                        coords = c(1, 2), 
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_08, best_cells_08)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.)))
...
poss_pts_09 <- st_as_sf(data.frame(bs_09), 
                        coords = c(1, 2), 
                        crs = 2193) %>% 
  mutate(VAL = terra::extract(ecc_09, best_cells_09)) %>%
  arrange(desc(VAL)) %>% 
  mutate(ID = seq(nrow(.)))
